...
function onSearchResponse(response) {
	...
	$.each(srchItems, function(index, item){
		...
		vidId = 'placeholder';
		vidThumbimg = '<pre><img id="thumb" src="'+vidThumburl+'" alt="No  Image  Available." style="width:auto;height:20%"><a class="btn btn-lg btn-default search-result" href="#nextstep" id="image-select" value="'+vidId+'">Select</a></pre>';                   
